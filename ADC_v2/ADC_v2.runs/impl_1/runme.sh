...
HD_PWD='C:/Users/ASUS/Desktop/FPGA/spdif/ADC_v2/ADC_v2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ADC_top.tcl -notrace
