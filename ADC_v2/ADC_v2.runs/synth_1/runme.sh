...
HD_PWD='C:/Users/ASUS/Desktop/FPGA/spdif/ADC_v2/ADC_v2.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ADC_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ADC_top.tcl
