...
HD_PWD='C:/Users/ASUS/Desktop/FPGA/spdif/spdif/spdif.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log spdif_topV2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source spdif_topV2.tcl
